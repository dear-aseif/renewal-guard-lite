...
export function EmptyState({ action, description, icon, title }: EmptyStateProps) {
  return (
    <div className="relative overflow-hidden rounded-xl border border-dashed border-emerald-500/20 bg-neutral-950/60 px-4 py-8 text-center shadow-card backdrop-blur-xl sm:px-8 sm:py-12">
      ...
      <p className="mt-5 font-mono text-[11px] font-medium uppercase tracking-[0.14em] sm:text-[10px] sm:tracking-[0.16em] text-emerald-300">Local workspace</p>
