...
const badgeClassName = 'inline-flex items-center gap-1.5 rounded-full border px-2.5 py-1.5 font-mono text-[10px] font-medium uppercase leading-none tracking-[0.08em] shadow-sm'
